...
export const testimonial = [
  {
    ...
    name: "Sparsh Verma",
    description:
      "As a diet expert, my job is to not only educate clients on healthy eating habits, but also to provide support and accountability I suggest everyone to use this app.. Thank you",
    role: "Diet Expert:",
  },
  {
    id: 2,
